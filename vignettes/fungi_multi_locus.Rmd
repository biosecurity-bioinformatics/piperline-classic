...
samdf <- samdf %>%
  mutate(pcr_primers = "ITS1Fngs-ITS2ngs;ITS7ngsOphio-ITS4ngsUni;LF402F-LR5Fungngs;CALngsF1-CALngsR1;EF1087Fngs-EF646Rngs",
  for_primer_seq = "GGTCATTTAGAGGAAGTAA;ARTCTTTGAACGCACATTG;GTGAAATTGYTRAAAGGGAA;CARGAYATGATYAACGAGG;GTTCGAGGCTGGTATCTCC",
  rev_primer_seq = "TTYRCKRCGTTCTTCATCG;CCTSCSCTTANTDATATGC;CGATCGATTTGCACGTCAG;GRATCATCTCRTCVACCTC;GTCTCRATACGGCCRAC"
  )
...
params <- tibble(
  # Run parameters
  pcr_primers = c("ITS1Fngs-ITS2ngs", "ITS7ngsOphio-ITS4ngsUni", "LF402F-LR5Fungngs", "CALngsF1-CALngsR1", "EF1087Fngs-EF646Rngs"),
  target_gene=c("ITS1", "ITS2", "LSU", "CAL", "TEF"),
  ...
  idtaxa_db = c("reference/rRNA_Jul2022.rds","reference/rRNA_Jul2022.rds", "reference/rRNA_Jul2022.rds",
             "reference/CAL_Aug2021.rds", "reference/TEF_Jul2022.rds"
             ),
  ref_fasta = "reference/insecta_hierarchial_bftrimmed.fa",
